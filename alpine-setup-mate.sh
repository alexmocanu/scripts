...
#There is no support for MATE in the setup-desktop script so we install everything manually
...
apk add cups cups-libs cups-client cups-filters system-config-printer 
...
#additional stuff for caja: gvfs plugins, fuse, ntfs, etc.
